    ...
    private String editGroup(HttpServletRequest request, String param) {
        ...
        try {
            if ("delete".equals(param)) {
                ...
                String staffId = request.getParameter("staffId");
                group.setGroupId(StringUtil.isEmpty(groupId) ? null : Integer.valueOf(groupId));
                ...
                group.setIs_del("0");
                group.setCreate_staffId(Integer.valueOf(staffId));
                group.setUpdate_staffId(Integer.valueOf(staffId));
