    ...
    private String editPermission(HttpServletRequest request, String param) {
        ...
        try {
            if ("delete".equals(param)) {
                ...
                permission.setPermissionId(StringUtil.isEmpty(permissionId) ? null : Integer.valueOf(permissionId));
                permission.setModuleId(Integer.valueOf(moduleId));
