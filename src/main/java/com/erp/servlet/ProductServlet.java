    ...
    private String editProduct(HttpServletRequest request, String param) {
        ...
        try {
            if ("add".equals(param)) {
                ...
                product.setProductId(StringUtil.isEmpty(productId) ? null : Integer.valueOf(productId));
                product.setProductName(productName);
                product.setProductDesc(productDesc);
                product.setJldwId(Integer.valueOf(jldwid));
                product.setPrice(Double.valueOf(price));
                product.setCreate_staffId(Integer.valueOf(create_by));
                product.setUpdate_staffId(Integer.valueOf(update_by));
