...
<head>
    ...
    <script type="text/javascript" src="<%= request.getContextPath()%>/js/index.js?version=<%= version%>"></script>
    ...
    <script type="text/javascript">
        ...
        function logout() {
            $.messager.confirm('确认框','确定退出${project.projectName}吗?',function(r){
                if (r){
                    window.location = "<%=request.getContextPath()%>/servlet/LoginServlet?param=loginout";
                }
            });
        }
        ...
        var url = (modules=='' || modules=='null' || modules==undefined)?"/servlet/ModuleServlet?param=query":"/servlet/RolePermissionServlet?param=query-modules";
        $(function(){
            //初始化accordion
...
<div class="easyui-layout" style="width:100%;height:100%">
    ...
    <div data-options="region:'north'" style="height:50px; width: 100%;background-image: url('images/logo.png')">
        <span style="text-align: right;">
            <div id="toolbar">
                ...
                <span>,&nbsp;您好,&nbsp;欢迎登录${project.projectName}! &nbsp;现在时间: &nbsp;</span>
    ...
    <!-- 模块栏 -->
    <div data-options="region:'west',split:true" title="${project.projectName}" style="width:180px;">
