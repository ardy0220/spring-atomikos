...
function queryProdtct() {
    $("#product1").datagrid({
        url:root + '/servlet/ProductServlet?param=query',
        queryParams:{
            seq: $("#seq").val()
        },
        method:'post'
...
function upOrDown(param, ids, flag) {
    $.ajax({
        url: root + "/servlet/ProductServlet",
        type: 'post',
        cache: false,
        dataType: 'json',
        traditional: true,
...
function queryPics() {
    $("#product1-grid").datagrid({
        url:root + '/servlet/FileUploadLogServlet?param=query',
        queryParams:{
            seq: $("#seq").val(),
...
function resumeOrDelPics(param, dbid) {
    $.ajax({
        url: root + "/servlet/FileUploadLogServlet",
        type: 'post',
        cache: false,
        dataType: 'json',
        traditional: true,
