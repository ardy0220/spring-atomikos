...
<table id="role-query" class="easyui-datagrid" title="角色管理" style="width:100%;height:100%"
       data-options="
				...
				singleSelect: true,
				rownumbers: true,
				url:'<%= request.getContextPath()%>/servlet/RoleServlet?param=query',
				method: 'post',
				<%--queryParams:{--%>
                    <%--seq: $('#seq').val()--%>
                <%--},--%>
            ...
            <tr>
                ...
                <td>
                    <input class="easyui-combobox" id="roleGroupCode" name="roleGroupCode"
                           ...
                           width:250,
                           required:true,
                           url: '<%= request.getContextPath()%>/servlet/GroupServlet?param=query-combo',
				           method: 'post',
				           valueField: 'groupId',
				           textField: 'groupName'
                           ">
    ...
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'center',title:'模块权限管理'" style="width:40%;height: 100%;padding:5px;background:#eee;">
            <table id="role-permission-query" class="easyui-datagrid"
				...
				rownumbers: true,
				fit: true,
				<%--url:'<%= request.getContextPath()%>/servlet/GroupServlet?param=query',--%>
				<%--method: 'post',--%>
				<%--queryParams:{--%>
                    <%--seq: $('#seq').val()--%>
                <%--},--%>
