...
function queryRole() {
    $("#role-query").datagrid({
        url:root + '/servlet/RoleServlet?param=query',
        // queryParams:{
        //     seq: $("#seq").val()
        // },
        method:'post'
...
function addRolePermission() {
    ...
    $('#role-permission-tree').tree({
        url: root+'/servlet/RolePermissionServlet?param=query-modules',
        animate: true,
        method: 'post',
        queryParams: {
            modules: modules
...
function queryPermission(id) {
    $("#role-permission-query").datagrid({
        url:root + '/servlet/PermissionServlet?param=query',
        queryParams:{
            moduleId: id
        },
        method:'post',
...
function queryRolePermission() {
    ...
    $("#role-permission-role-query").datagrid({
        url:root + '/servlet/RolePermissionServlet?param=query',
        queryParams:{
            roleId: roleId
        },
        method:'post'
...
function saveRolePermission() {
    ...
    $.messager.confirm('保存确认框', '确定保存数据吗？', function (r) {
        if (r) {
            $.ajax({
                url: root + "/servlet/RolePermissionServlet",
                type: 'post',
                cache: false,
                dataType: 'json',
                traditional: true,
