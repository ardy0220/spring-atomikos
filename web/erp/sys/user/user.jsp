...
<table id="user-query" class="easyui-datagrid" title="物料明细" style="width:100%;height:100%"
       data-options="
				iconCls: 'icon-search',
				singleSelect: false,
				url:'<%= request.getContextPath()%>/servlet/UserServlet?param=user-query',
				method: 'post',
				queryParams:{
                    seq: $('#seq').val()
                },
    ...
    <tr>
        ...
        <th data-options="field:'update_date',width:150">更新时间</th>
        <th data-options="field:'last_login_time',width:150">最后登录时间</th>
            ...
            <tr>
                ...
                <td>
                    <input class="easyui-combobox" id="styleid" name="styleid"
                           data-options="
                           required:true,
                           url: '<%= request.getContextPath()%>/servlet/StyleServlet?param=query-combo',
				           method: 'post',
				           valueField: 'styleId',
				           textField: 'style'
                           ">
            ...
            <tr>
                ...
                <td>
                    <input class="easyui-combobox" id="roleId" name="roleId"
                           data-options="
                           <%--required:true,--%>
                           url: '<%= request.getContextPath()%>/servlet/RoleServlet?param=query-combo',
                           value: '0',
				           method: 'post',
				           valueField: 'roleId',
				           textField: 'roleName'
