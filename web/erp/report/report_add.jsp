...
<table id="report-add" class="easyui-datagrid" title="填报" style="width:100%;height:100%"
       data-options="
				...
				singleSelect: false,
				rownumbers:true,
				url:'<%= request.getContextPath()%>/servlet/ReportServlet?param=query',
				method: 'post',
				queryParams:{
                    seq: $('#seq').val()
                },
        ...
        <th data-options="field:'wlbm',width:150,
						...
						editor:{
							...
							options:{
								...
								textField:'wlmc',
								method:'post',
								url:'<%= request.getContextPath()%>/servlet/combo/ComboBoxServlet?param=wl-combo',
								mode:'remote',
								required:true
							}
						}">物料</th>
        ...
        <th data-options="field:'gysbm',width:150,
						...
						editor:{
							...
							options:{
								...
								textField:'gysmc',
								method:'post',
								url:'<%= request.getContextPath()%>/servlet/combo/ComboBoxServlet?param=gys-combo',
								mode:'remote',
								required:true
							}
						}">供应商</th>
